       ...
       /*  it('gets the price of wFTM', async function() {
        ...
        it('Scenario 1', async function(){
            ...
            *The two amounts should be the same`);
            ...
            console.log(`
            The amount of wFTM that borrower is refunded: ${weiToEther(balance2)}`);
        ...
        it('Scenario 3', async function(){
            ...
            *Bidder1 bids all the collateral but will fail as he forgets to approve enough 
            ...
            await expectRevert(this.fantomLiquidationManager.bidAuction(1, new BN('100000000'), {from: bidder1}),"Low allowance of debt token.");
