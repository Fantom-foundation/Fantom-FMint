...
interface IFantomDeFiTokenStorage {
    ...
    function totalOf(address _account, bool requireTradable) external view returns (uint256);
    ...
    function totalOfInc(address _account, address _token, uint256 _amount, bool requireTradable) external view returns (uint256);
    ...
    function totalOfDec(address _account, address _token, uint256 _amount, bool requireTradable) external view returns (uint256);
