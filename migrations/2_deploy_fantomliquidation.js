...
module.exports = async function(deployer, network, accounts) {
    ...
    if (network === 'ganache'){
        ...
        await fantomLiquidationManager.initialize(owner, fantomMintAddressProvider.address);
        ...
        await fantomMintRewardDistribution.initialize(owner, fantomMintAddressProvider.address);
        ...
        await fantomMintAddressProvider.setPriceOracleProxy(mockPriceOracleProxy.address);
        ...
        await fantomMintTokenRegistry.addToken(mockToken.address,"", mockPriceOracleProxy.address, 18,  true, true, false);
        await fantomMintTokenRegistry.addToken(fantomFUSD.address,"", mockPriceOracleProxy.address, 18,  true, false, true);
        ...
        await mockToken.approve(fantomMint.address, etherToWei(9999), {from: borrower});
        await fantomMint.mustDeposit(mockToken.address, etherToWei(9999), {from: borrower});
